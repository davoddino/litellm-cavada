...
export const pageDescriptions: Record<string, string> = {
  ...
  "cavadalabs-companies": "Manage CavadaLabs tenant companies and billing ownership",
  "cavadalabs-projects": "Manage CavadaLabs projects linked to companies, runtime, billing, and governance",
